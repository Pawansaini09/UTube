...
import UTube from "../../public/UTube.jpg";
...
function Navbar() {
  ...
  if (searchbar) {
    return (
      <div className="flex justify-between fixed top-0 w-[100%] bg-white px-6 items-center py-2 ">
  ...
  return (
    <div className="flex justify-between fixed top-0 w-[100%] bg-white px-6 py-2 ">
      <div className="flex items-center space-x-4 ">
        ...
        />
        <img src={UTube} alt="" className="w-28 cursor-pointer" />
      </div>
