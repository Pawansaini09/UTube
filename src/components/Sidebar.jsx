...
function Sidebar() {
  ...
  const ModelOverlay = () => {
    return (
      <div
        className="flex fixed top-0 right-0 bottom-0 bg-black/50 z-30"
  ...
  return (
    <>
      <div
        ...
        } xl:static xl:block px-2 lg:px-6 overflow-x-hidden overflow-y-scroll scrollbar-none scrollbar-thin  `}
      >
        {/* Home */}
            ...
            return (
              <div className="mb-5">
                ...
                {group.groupItems.map((item) => (
                  <div
                    key={item.id}
                    className="flex items-center space-x-6 hover:bg-gray-300 duration-300 rounded-xl my-3 p-1"
                  >
